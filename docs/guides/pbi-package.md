# PBI-Scope Package Usage Guide

The `pbi` package provides a simple Python interface for accessing and querying the PBI-Scope (Phage Bacteria Interactions) data product. This guide covers the main features and usage patterns.
