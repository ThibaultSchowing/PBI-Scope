...
COLUMNS_LIST = [
    ...
    "Evidence_Level", "Phage_Source", "Source_DB"
]
...
STRING_COLUMNS = ["Phage_ID", "CRISPR_ID", "Potential_Orientation (AT%)", "CRISPRDirection", "Consensus_Repeat", "Repeat_ID (CRISPRdb)", "Phage_Source", "Source_DB"]
