...
COLUMNS_LIST = ["Protein_ID", "Aligned_Protein_in_VFDB", "Phage_ID", "Phage_Source", "Source_DB"]
NUMERICAL_COLUMNS = []
STRING_COLUMNS = ["Protein_ID", "Aligned_Protein_in_VFDB", "Phage_ID", "Phage_Source", "Source_DB"]
